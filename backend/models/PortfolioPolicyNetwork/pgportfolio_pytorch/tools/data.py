...
def get_type_list(feature_number):
    """
    aim: to obtain the information related to download data
    ...
    if feature_number == 1:
        ...
        type_list = ["close", "high", "low", "open", "volumn"]  # there may be some error regarding volumn 
    else:
...
def panel_fillna(panel, type="bfill"):
    """ 
    aim: fill nan along the 3rd axis
    :param panel: the panel to be filled
    :param type: bfill (backward fill) or ffill (forward fill)
    """
    frames = {}
