...
import numpy as np
from pgportfolio_pytorch.marketdata.datamatrices import DataMatrices
from pgportfolio_pytorch.marketdata.globaldatamatrix import HistoryManager
from pgportfolio_pytorch.tools.configprocess import parse_time
from pgportfolio_pytorch.constants import *
from pgportfolio_pytorch.tools.data import get_volume_forward
...
def asset_vector_to_dict(coin_list, vector, with_BTC=True):
    # transform the vector to dictionry
